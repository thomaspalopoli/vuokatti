...
console.log(ui.item);
			if(ui.item.hasClass('navigation')) {


          ui.item.find('.fixed-topnav').addClass('gugugu');
          /*
          if(ui.item.parent().find('.current-navigation').length){
              ui.item.hide();
              bootbox.confirm('<p style="font-size:15px">Are you sure you want to remove current navigation (all changes inside navigation will be lost)?</p>', function(result) {
                  if(result === true){
                      ui.item.parent().find('.current-navigation').remove();
                      ui.item.addClass('current-navigation');
                      ui.item.show();
                  }
                  else{
                    ui.item.parent().find('.element:not(.current-navigation)').remove();
                  }
              }); 
          }
          else {
...
$(function(){
		...
		for( x=0; x<_Elements.elements[key].length; x++ ) {
			if( _Elements.elements[key][x].thumbnail == null ) {//we'll need an iframe
				...
				if( _Elements.elements[key][x].sandbox != null ) {
					...
					newItem = $('<li class="element '+niceKey+'"><p>' + _Elements.elements[key][x].title + '</p><img src="'+_Elements.elements[key][x].thumbnail+'" data-srcc="'+_Elements.elements[key][x].url+'" data-height="'+_Elements.elements[key][x].height+'" data-sandbox="" '+loaderFunction+'></li>')
				} else {
					newItem = $('<li class="element '+niceKey+'"><p>' + _Elements.elements[key][x].title + '</p><img src="'+_Elements.elements[key][x].thumbnail+'" data-srcc="'+_Elements.elements[key][x].url+'" data-height="'+_Elements.elements[key][x].height+'"></li>')
				}
			}
	...
	$('#previewModal').on('shown.bs.modal', function (e) {
	        ...
	        theContents.find('.map').each(function() {
	            $(this).attr('style', '');
	            $(this).empty();
	            mapScripts = '<script src="http://maps.google.com/maps/api/js?sensor=true"></script><script src="../../common-files/plugins/google-maps/gmaps.min.js"></script><script src="https://google-maps-utility-library-v3.googlecode.com/svn-history/r391/trunk/markerwithlabel/src/markerwithlabel.js"></script><script src="../../common-files/js/map.js"></script>';
	        });
	        ...
	        theContents.find('.owl-carousel').each(function() {
				...
				var themeHeader = '<!DOCTYPE HTML>\n' +
	                        ...
	                        '      <link rel="stylesheet" href="../../common-files/plugins/text-rotator/simpletextrotator.min.css">\n' +
	                        '      <link rel="stylesheet" href="../../common-files/plugins/slider-revolution/examples/rs-plugin/css/settings.css" media="screen" />\n' +
	                        '      <link rel="stylesheet" href="../../common-files/plugins/magnific/magnific-popup.min.css" rel="stylesheet">\n' +
	                        '      <link rel="stylesheet" href="../../common-files/plugins/rateit/rateit.css"rel="stylesheet">\n' +
	                        '      <!-- END PAGE STYLE -->\n' +
	                        '      <!-- [if lt IE 9]>\n' +
	      ...
	      var themeFooter = '  <a href="#" class="scrollup"><i class="fa fa-angle-up"></i></a>\n' +
	                        ...
	                        '  <script src="../../common-files/plugins/bootstrap-dropdown/bootstrap-hover-dropdown.js"></script>\n' +
	                        '  <!-- BEGIN PAGE SCRIPTS -->\n' +
	                        '  <script src="../../common-files/plugins/backstretch/backstretch.min.js"></script>\n' +
	                        ...
	                        '  <script src="../../common-files/plugins/text-rotator/jquery.simple-text-rotator.min.js"></script>\n' +
	                        ...
	                        '  <script src="../../common-files/plugins/magnific/jquery.magnific-popup.min.js"></script>\n' +
	                        '  <script src="../../common-files/plugins/rateit/jquery.rateit.min.js"></script> \n' +
	                        '  <script src="../../common-files/js/ecommerce.js"></script>\n' +
	                        ...
	                        '  <script src="../../common-files/plugins/animated-background/demo-2.js"></script>\n' +
